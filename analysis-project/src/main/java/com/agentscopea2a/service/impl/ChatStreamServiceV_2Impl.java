...
@Service
public class ChatStreamServiceV_2Impl implements ChatStreamServiceV_2 {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ChatStreamServiceV_2Impl.class);
    ...
    public ChatStreamServiceV_2Impl(
