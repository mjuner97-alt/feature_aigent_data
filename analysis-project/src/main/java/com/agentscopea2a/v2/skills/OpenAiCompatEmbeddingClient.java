 ...
 * off — until embeddings are wired into a working endpoint, consumers see a
 * missing bean via {@code ObjectProvider} and silently fall back to non-embedding routing.
 *
 ...
 * degraded recall quality, not a 500.
 */
@Component
