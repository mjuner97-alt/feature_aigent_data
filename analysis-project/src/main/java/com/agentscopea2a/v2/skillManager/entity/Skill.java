 ...
 *
 * <p>由 {@code com.agentscopea2a.v2.skillManager.service.SkillManageService} 管理；表 {@code skill_manage}
 ...
 *
 * <p>包路径受 {@code MySQLConfig.setTypeAliasesPackage("com.agentscopea2a.v2.skillManager.entity")} 约束，
...
public class Skill {
    ...
    /**
     * 可见性三态:
     * PUBLIC=公开(选维度发布,审批通过后维度内可见) /
     * PRIVATE=私有(owner+skill_visible_grant 授权可见,授权即时生效) /
     * PERSONAL=个人(不选发布维度,仅创建者使用,新建默认)。
     */
