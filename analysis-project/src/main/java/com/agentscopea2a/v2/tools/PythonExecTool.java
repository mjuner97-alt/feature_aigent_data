...
import com.agentscopea2a.v2.config.V2ToolConfig.PythonExecPropertiesV2;
 ...
 * component-scanned. Uses v2 {@link SandboxPropertiesV2} and {@link PythonExecPropertiesV2}.
 *
...
public class PythonExecTool {
    ...
    public PythonExecTool(SandboxPropertiesV2 sandboxProps) {
        this(sandboxProps, null);
    }

    public PythonExecTool(SandboxPropertiesV2 sandboxProps, PythonExecPropertiesV2 pyProps) {
    ...
    @Timed(value = "python_exec.duration", description = "python_exec tool call duration", percentiles = {0.5, 0.9, 0.99})
