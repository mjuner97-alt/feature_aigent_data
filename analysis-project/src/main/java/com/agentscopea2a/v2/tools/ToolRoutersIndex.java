...
/**
 * Tool router — uses reflection to discover {@code @Tool} methods on injected beans and
 * routes JSON-parameter calls through the {@code router_tool} meta-tool.
 *
...
public class ToolRoutersIndex {
    ...
    @Timed(value = "router_tool.duration", description = "router_tool meta-tool dispatch duration", percentiles = {0.5, 0.9, 0.99})
