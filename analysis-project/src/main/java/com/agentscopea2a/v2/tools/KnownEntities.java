 ...
 *
 * <p>Moved from {@code harness.tools} to {@code v2.tools} so it remains compilable under
 * the v2 compiler excludes. v1 callers (QualityTools) are already excluded from compilation.
 */
