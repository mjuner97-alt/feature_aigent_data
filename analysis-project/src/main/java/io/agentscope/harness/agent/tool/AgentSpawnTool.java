...
public class AgentSpawnTool {
    ...
    // SHADOW PATCH: upstream 30s too short — remote MySQL cold connect + slow SQL trips
    // `Timeout on blocking read for 30000000000 NANOSECONDS`. Raise default to 600, max to 3600.
