 ...
 *   <li>{@code SemanticMemoryProvider} — Wraps existing {@link LongTermMemory}</li>
 ...
 * </ol>
 *
 * <p><b>Design Reference:</b> Hermes Agent MemoryProvider concept.
 *
 * @see MemoryManager
 * @see BuiltInMemoryProvider
 * @see SemanticMemoryProvider
 */
