...
import { Files, Grid } from '@element-plus/icons-vue';
...
const S: any = {
  ...
  navItem: { padding: '12px 20px', fontSize: '0.88rem', fontWeight: 600, textDecoration: 'none', cursor: 'pointer', borderBottom: '2px solid transparent', display: 'inline-flex', alignItems: 'center', gap: '6px' },
